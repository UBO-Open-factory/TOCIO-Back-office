...
class MethodController extends Controller
{
    ...
    public function actionCreate()
    {
        ...
        $list = str_replace(' ', '', Cartes::find()->select(['nom'])->indexBy('nom')->column());

        $method_pre['list'] = array_combine($list , $list);

        return $this->render('create', ['model' => $model,'method_pre' => $method_pre]);
    }
    ...
    public function actionUpdate($id)
    {
        ...
        return $this->render('update', ['model' => $model,'method_pre' => $method_pre]);
    }
    ...
    {
        foreach(relcartesmethod::find()->where(["id_method" => $id])->all() as $id_method)
        {
            relcartesmethod::find()->where(["id_method" => $id])->one()->delete();
        }
