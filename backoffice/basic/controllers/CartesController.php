...
class CartesController extends Controller
{
    ...
    {
        foreach(relcartesmethod::find()->where(["id_carte" => $id])->all() as $id_method)
        {
            relcartesmethod::find()->where(["id_carte" => $id])->one()->delete();
        }
    ...
    public function actionAjaxupdate() {
        ...
        return ["success" => "** Oupsss, il y a eu un problème à la mise à jour de la carte ".$model::className()."\n", "errors" => json_encode($model->errors)];
    }
